...
| `send_to_agent` | Message another agent — a project agent, the super-agent, or a coding runtime — and get their answer. The exchange is filed as an agent-to-agent conversation you can read and continue. Agents use this instead of shelling out to `apx send`, which blocks the whole turn |
