...
- [Tasks](/apx/capabilities/tasks/) — per-project TODO list that routines can read and write.
- [Super-agent](/apx/capabilities/super-agent/) — the mode that `super_agent` routines run under.
- [Configuration](/apx/concepts/configuration/) — global model fallback and permission settings.
