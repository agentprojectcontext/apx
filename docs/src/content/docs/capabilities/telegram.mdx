...
- [Concepts — Agents](/apx/concepts/agents/) — how agents handle inbound messages
- [Capabilities — Super-agent](/apx/capabilities/super-agent/) — the default handler for Telegram messages
