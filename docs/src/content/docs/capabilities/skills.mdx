...
- [Capabilities — Agent Vault](/apx/capabilities/agent-vault/) — reusable agent templates
- [Concepts — Agents](/apx/concepts/agents/) — attaching skills to agents via frontmatter
