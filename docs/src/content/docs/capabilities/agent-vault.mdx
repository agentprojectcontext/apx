...
For per-project agent CRUD (adding, editing, memory) see [Concepts — Agents](/apx/concepts/agents/).
...
- [Concepts — Agents](/apx/concepts/agents/) — per-project agent CRUD, memory, and the `AGENT.md` format
- [Capabilities — Skills](/apx/capabilities/skills/) — reusable instruction sets you can attach to agents
