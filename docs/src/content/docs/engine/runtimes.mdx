...
any external process. See [Engines](/apx/engine/engines/) for that path.
...
- [Engines](/apx/engine/engines/) — direct LLM calls with `apx exec` and `apx chat`
- [Configuration](/apx/concepts/configuration/) — `~/.apx/config.json` reference
