...
| `send_to_agent` | Escribirle a otro agente — uno de proyecto, el super-agente o un runtime de código — y recibir su respuesta. El intercambio queda como conversación agente-a-agente que podés leer y continuar. Los agentes usan esto en vez de salir por shell a `apx send`, que bloquea el turno entero |
