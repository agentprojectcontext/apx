...
- Con el analizador activo, la calificación de riesgo reemplaza la confirmación estática por
  herramienta peligrosa de `automatico`; las allowlists de `permiso` siguen aplicando, y el modo
  `total` saltea el gate por completo.
