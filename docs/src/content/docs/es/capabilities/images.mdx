...
Cuando fallan todos, el error nombra cada motor que probó, dónde vive ese servidor y qué dijo
el servidor mismo, así una máquina rota se identifica con solo leer el mensaje:

<Terminal command={`apx image "un zorro"`}>
