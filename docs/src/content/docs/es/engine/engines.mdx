...
El trabajo en segundo plano — rutinas y agentes hablando entre sí — tiene un techo de llamadas al
modelo por hora, contado sobre la última hora, global y por proyecto. Si lo pasa, ese trabajo se
pausa (30 minutos por defecto) y te llega una sola línea por Telegram; tus propios chats nunca se
pausan. Los límites están en `super_agent.spend_breaker`:
