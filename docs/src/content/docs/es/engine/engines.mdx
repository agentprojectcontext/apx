...
turno, y los turnos que nadie mira (a2a, rutinas) frenan en vez de caer por la cadena — ver
[la página del super-agente](/apx/docs/es/capabilities/super-agent/). Para el plan de ChatGPT, el
esfuerzo de razonamiento va en el id del modelo — `chatgpt-codex:gpt-5.6-luna@medium`
(`minimal|low|medium|high|xhigh`) — o como default en `engines.chatgpt-codex.reasoning_effort`.
