...
por fila. Un proyecto tiene dos: **Memoria del proyecto** (`.apc/memory.md`), curada y
committeada con el repo, y **Memoria local** (`~/.apx/projects/<id>/memory.md`), que escribe
la tool `remember` del super-agente y que git no ve nunca — así un dato levantado en medio de
una charla no te mete una credencial pegada en el historial. Promover una línea de local a
committeada es una edición manual acá. Abajo va la memoria propia de cada agente. La libreta
