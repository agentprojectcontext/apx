...
de cada agente, el contexto de larga vida que los agentes leen en cada turno. Ahí mismo
escribe la tool `remember` del super-agente cuando le contás un dato de este proyecto.
La libreta propia del super-agente (`~/.apx/memory.md`) es global, no de un proyecto,
