...
- [Configuration reference](/apx/concepts/configuration/) — full `~/.apx/config.json` schema.
- [CLI surface](/apx/surfaces/cli/) — shell integration, environment variables, and advanced usage.
- [CLI Cheatsheet](/apx/reference/cli-cheatsheet/) — every command at a glance.
