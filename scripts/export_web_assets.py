...
BLOBS = {
    ...
    "perla":    ("Perla",    "#15181C", (0.40, 0.55, 0.35, 0.075, 0.095)),
    "faro":     ("Faro",     "#15181C", (0.37, 0.51, 0.42, 0.070, 0.090)),
    "brasa":    ("Brasa",    "#15181C", (0.39, 0.53, 0.38, 0.075, 0.095)),
    "aqua":     ("Aqua",     "#15181C", (0.31, 0.45, 0.34, 0.070, 0.090)),
    "coral":    ("Coral",    "#15181C", (0.40, 0.54, 0.60, 0.068, 0.085)),
    "zafiro":   ("Zafiro",   "#15181C", (0.42, 0.56, 0.44, 0.075, 0.095)),
    "pino":     ("Pino",     "#15181C", (0.45, 0.59, 0.46, 0.070, 0.090)),
    "eclipse":  ("Eclipse",  "#060709", (0.42, 0.55, 0.42, 0.070, 0.090)),
    "peon":     ("Peón",     "#15181C", (0.42, 0.56, 0.30, 0.060, 0.080)),
    "ovni":     ("Ovni",     "#15181C", (0.44, 0.58, 0.42, 0.070, 0.085)),
    "amatista": ("Amatista", "#15181C", (0.35, 0.49, 0.42, 0.075, 0.095)),
    "volcan":   ("Volcán",   "#15181C", (0.40, 0.53, 0.30, 0.065, 0.085)),
    ...
    "caracol":  ("Caracol",  "#15181C", (0.58, 0.72, 0.45, 0.065, 0.085)),
