// apx help — the entire help surface: topic data, aliases, and rendering.
//
// This was ~1900 lines of help *data* sitting inside cli/index.js, which made
// that file 3001 lines and buried the 458-line dispatch() at the bottom of it.
// The data was already declarative; it just had no home of its own.
//
// A topic is data, not code: title, summary, usage, commands, options,
...
export const HELP_TOPICS = new Map(Object.entries({
  init: topic({
    title: "apx init",
...
export const HELP_ALIASES = new Map(Object.entries({
...
export function buildTopicHelp(t) {
  const lines = [
    "",
...
export function findHelpTopic(argv) {
