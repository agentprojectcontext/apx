...
// shade (600/700, ~4.5:1 on its own tint), the dark value is the shade the app
// already used. Dark mode is therefore unchanged by construction — the old class
// is still there, just behind `dark:`.
//
 ...
 * definition comes from the border and the ink, not from a louder fill.
 */
export const toneChip: Record<Tone, string> = {
  emerald: "border border-emerald-600/25 bg-emerald-500/12 text-emerald-700 dark:border-emerald-500/40 dark:bg-emerald-500/20 dark:text-emerald-300",
  green:   "border border-green-600/25 bg-green-500/12 text-green-700 dark:border-green-500/40 dark:bg-green-500/20 dark:text-green-300",
  lime:    "border border-lime-600/25 bg-lime-500/12 text-lime-700 dark:border-lime-500/40 dark:bg-lime-500/20 dark:text-lime-300",
  teal:    "border border-teal-600/25 bg-teal-500/12 text-teal-700 dark:border-teal-500/40 dark:bg-teal-500/20 dark:text-teal-300",
  cyan:    "border border-cyan-600/25 bg-cyan-500/12 text-cyan-700 dark:border-cyan-500/40 dark:bg-cyan-500/20 dark:text-cyan-300",
  sky:     "border border-sky-600/25 bg-sky-500/12 text-sky-700 dark:border-sky-500/40 dark:bg-sky-500/20 dark:text-sky-300",
  blue:    "border border-blue-600/25 bg-blue-500/12 text-blue-700 dark:border-blue-500/40 dark:bg-blue-500/20 dark:text-blue-300",
  indigo:  "border border-indigo-600/25 bg-indigo-500/12 text-indigo-700 dark:border-indigo-500/40 dark:bg-indigo-500/20 dark:text-indigo-300",
  violet:  "border border-violet-600/25 bg-violet-500/12 text-violet-700 dark:border-violet-500/40 dark:bg-violet-500/20 dark:text-violet-300",
  purple:  "border border-purple-600/25 bg-purple-500/12 text-purple-700 dark:border-purple-500/40 dark:bg-purple-500/20 dark:text-purple-300",
  pink:    "border border-pink-600/25 bg-pink-500/12 text-pink-700 dark:border-pink-500/40 dark:bg-pink-500/20 dark:text-pink-300",
  rose:    "border border-rose-600/25 bg-rose-500/12 text-rose-700 dark:border-rose-500/40 dark:bg-rose-500/20 dark:text-rose-300",
  red:     "border border-red-600/25 bg-red-500/12 text-red-700 dark:border-red-500/40 dark:bg-red-500/20 dark:text-red-300",
  orange:  "border border-orange-600/25 bg-orange-500/12 text-orange-700 dark:border-orange-500/40 dark:bg-orange-500/20 dark:text-orange-300",
  amber:   "border border-amber-600/25 bg-amber-500/12 text-amber-700 dark:border-amber-500/40 dark:bg-amber-500/20 dark:text-amber-300",
  slate:   "border border-slate-500/25 bg-slate-500/12 text-slate-700 dark:border-slate-500/40 dark:bg-slate-500/20 dark:text-slate-300",
};
