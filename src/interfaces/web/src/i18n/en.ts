...
export const en = {
  ...
  voice_ui: {
    ...
    qvox_install_title: "Add a local voice on this Mac",
  },
  ...
  tasks: {
    ...
    prompt_hint:     "What the agent receives when the task runs. Optional: leave it empty and the title is the whole instruction.",
    confirm_done_title: "Complete task?",
    confirm_done_desc:  "Marks “{title}” as done. You can reopen it later.",
