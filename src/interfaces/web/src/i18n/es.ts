...
export const es = {
  ...
  settings_ui: {
    ...
    kw_triggers_title:          "Triggers por palabra clave (opción B)",
    kw_triggers_desc:           "Activación alternativa, estilo OpenHands. Las skills que declaran `triggers:` (una lista de palabras clave) en su frontmatter se inyectan automáticamente cuando una palabra clave aparece en el mensaje del usuario (substring, sin distinguir mayúsculas). Si hay match, el paso del inspector/RAG se saltea ese turno. Apagado por defecto — el inspector semántico sigue siendo el mecanismo principal.",
    enable_kw_triggers:         "Habilitar triggers por palabra clave",
    enable_kw_triggers_hint:    "Off = las skills se activan por /slug, el inspector o la sugerencia pasiva. On = un match por palabra clave también inyecta el cuerpo de la skill.",
    kw_max_matches:             "Máx. matches",
    kw_max_matches_hint:        "Cuántas skills pueden inyectarse por palabra clave por turno.",
    kw_body_char_cap:           "Tope de chars del cuerpo",
    kw_body_char_cap_hint:      "Recorta los cuerpos largos para que no inflen el contexto.",
    kw_skills_title:            "Skills con triggers",
    kw_no_skills:               "Ninguna skill declara `triggers:` en su frontmatter todavía. Agregá p. ej. `triggers: [deploy, release]` a un SKILL.md.",
