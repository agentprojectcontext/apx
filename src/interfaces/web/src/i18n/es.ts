...
export const es = {
  ...
  tasks: {
    ...
    prompt_hint:     "Lo que recibe el agente cuando corre la task. Opcional: si lo dejás vacío, la instrucción es el título.",
    confirm_done_title: "¿Completar la task?",
    confirm_done_desc:  "Se marca «{title}» como hecha. Podés reabrirla después.",
