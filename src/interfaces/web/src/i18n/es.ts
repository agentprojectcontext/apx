...
export const es = {
  ...
  add_project: {
    ...
    init_hint: "Crea .apc/ en esa carpeta cuando todavía no es un proyecto APC, en vez de fallar.",
  ...
  mobile: {
    chats_title: "Chats",
    runtimes_title: "Sesiones de código",
    runtimes_search: "Buscar por engine, proyecto o resultado",
    runtimes_all: "Todas",
    runtimes_failed: "Con error",
    runtimes_running: "Corriendo",
    runtimes_finished: "Terminadas",
    runtimes_abandoned: "Sin cerrar",
    ...
    runtimes_agent: "Lanzada por",
    runtimes_notes: "Notas de la sesión",
    runtimes_info: "Datos de la sesión",
    runtimes_new: "Sesión de código",
    runtimes_new_hint: "Con Claude Code, Codex u OpenCode",
    runtimes_new_engine: "Engine",
    runtimes_new_where: "Carpeta",
    runtimes_new_where_hint: "Dónde abre. Vacío = la carpeta del proyecto.",
    runtimes_new_prompt: "¿Qué querés que haga?",
    runtimes_new_start: "Arrancar",
    runtimes_engines_loading: "Buscando qué engines tenés instalados…",
    runtimes_none_installed: "No se encontró ningún CLI de código en esta máquina.",
    runtimes_on_behalf: "En tu nombre",
    runtimes_you: "Vos",
    runtimes_empty_thread: "Todavía no se dijo nada en esta sesión.",
    runtimes_reply_ph: "Escribile a {runtime}…",
    runtimes_reply_hint: "Le llega directo al engine: retoma esta sesión, sin pasar por el super-agente.",
    runtimes_send: "Enviar",
    runtimes_sent: "Listo — retomando la sesión. El resultado va a aparecer en el chat.",
    agents_title: "Agentes",
    agents_search: "Buscar por nombre, rol o área",
    agents_all_projects: "Todos",
    agents_empty: "Todavía no hay agentes.",
    agents_master: "Principal",
    agents_chat: "Abrir chat",
    agents_name: "Nombre",
    agents_avatar: "Avatar",
    agents_saved: "Agente actualizado.",
    agents_role: "Rol",
    agents_area: "Área",
    agents_type: "Tipo",
    agents_model: "Modelo",
    agents_autonomy: "Autonomía",
    agents_parent: "Responde a",
    agents_skills: "Skills",
    agents_tools: "Tools",
    agents_tools_default: "Sin lista propia: usa el set completo por defecto.",
    agents_prompt: "System prompt",
    agents_prompt_more: "Leerlo entero",
    ...
    new_task: "Nueva task",
    new_commitment: "Nueva promesa",
    edit: "Editar",
    // Lo que se ve al deslizar una fila.
    swipe_done: "Completar",
    swipe_drop: "Descartar",
    swipe_reopen: "Reabrir",
    swipe_kept: "Cumplida",
    swipe_missed: "Incumplida",
    // El número del tab. Cuenta lo que se debe HOY, no todo lo abierto: un 31
    // permanente deja de querer decir algo.
    tab_tasks_badge: "{count} para hoy o vencidas",
    tab_commitments_badge: "{count} promesas vencidas",
    tab_chats_badge: "{count} chats sin leer",
  },
  notify: {
  ...
  milestones: {
    rail_title:      "Recorrido",
    steps_count:     "{n} pasos",
    steps_count_one: "1 paso",
    open_count:      "{n} abiertos",
    open_count_one:  "1 abierto",
    failed_count:    "{n} fallaron",
    failed_count_one: "1 falló",
    unnamed_step:    "Paso sin nombre",
    never_answered:  "Nunca se respondió",
    running_now:     "Respondiendo",
    superseded_repeated: "Se mandó dos veces — la segunda está abajo",
    superseded_replaced: "Lo reemplazaste apenas lo mandaste",
    title:           "Recorrido",
    ...
    range_week:      "7 días",
    range_month:     "30 días",
    only_unfinished: "Sólo lo no terminado",
  ...
  settings: {
    ...
    whatsapp: {
      title: "WhatsApp",
      subtitle: "Una cuenta, vinculada por QR. No se le contesta a nadie hasta que digas quién es — empezando por vos.",
      contacts_hint: "Todos los que escribieron. A un invitado nunca se le contesta — tildá para contestarle, cruz para seguir en silencio.",
      role_guest: "Invitado",
      role_contact: "Contacto",
      role_owner: "Dueño",
      accept: "Contestarle",
      reject: "Seguir en silencio",
      to_review: "Esperándote",
      to_review_hint: "APX los agregó porque le pediste que les escribiera. Ya pueden contestarles — decí quiénes son, o dejalos así.",
      everyone: "Todos los demás",
      chats_hint: "Todas las conversaciones de esta línea. Abre el hilo en el inbox.",
      no_chats: "Todavía no te escribió nadie por WhatsApp.",
      pending_review: "Sin revisar",
      pending_review_hint: "APX lo agregó porque le pediste que le escribiera. Ya puede contestarle — decile quién es cuando puedas.",
      edit: "Editar",
      make_owner_confirm: "Esta persona pasa a ser vos: sus mensajes reciben el agente completo, con tools, memoria y tus proyectos. Hacelo solo con una dirección desde la que escribís vos.",
      remove_confirm: "Lo saca de la lista junto con todo lo que hayas escrito sobre él. Va a volver como invitado — sin respuesta — la próxima vez que escriba.",
      is_owner_note: "Sos vos. Los mensajes de acá reciben el agente completo.",
      rel_partner: "Pareja",
      rel_family: "Familia",
      rel_child: "Hijo/a",
      rel_friend: "Amigo/a",
      rel_colleague: "Compañero/a de trabajo",
      rel_business_partner: "Socio/a",
      rel_client: "Cliente",
      rel_supplier: "Proveedor",
      rel_acquaintance: "Conocido/a",
      rel_other: "Otro",
      pending: "Pendientes",
      pending_hint: "Lo que pidió la gente. Nada de esto pasó todavía — la conversación no agenda nada sola.",
      no_pending: "Nada esperando. Los pedidos aparecen acá cuando un contacto pide algo y vos se lo habilitaste.",
      kind_appointment: "Turno",
      kind_errand: "Pedido",
      urgent: "Urgente",
      schedule: "Agendar",
      scheduled: "Agregado a tu calendario",
      mark_done: "Marcar como resuelto",
      dismiss: "Descartar",
      they_said: "Dijo",
      start: "Empieza",
      minutes: "Minutos",
      schedule_hint: "Crea el evento en tu Google Calendar. Al contacto no se le avisa — escribile vos si tiene que enterarse.",
      capabilities: "Qué puede hacer esta conversación",
      capabilities_hint: "Todo apagado por defecto. Nada de esto actúa solo — capturan lo que pidieron, o contestan desde un texto tuyo.",
      cap_appointments: "Tomar pedidos de turno",
      cap_errands: "Tomar pedidos",
      cap_facts: "Contestar desde mis notas",
      facts: "Qué puede decir sin consultarte",
      facts_hint: "Dirección, horarios, precios — lo que a esta persona se le puede decir directo. Lo que no esté acá sigue siendo algo que el agente no sabe.",
      no_sticker_image: "Sin imagen",
      stickers_hint: "Se describen una vez al llegar y después se recuerdan. Si editás el texto, queda tuyo — el modelo no lo pisa. `send_whatsapp` puede mandarlos de vuelta.",
      session: "Sesión",
      contacts: "Contactos",
      stickers: "Stickers",
      state: {
        ...
        pairing: "Esperando que escanees el QR",
        connected: "Conectado",
        logged_out: "Sesión cerrada — vinculá de nuevo",
      },
      pair: "Vincular un teléfono",
      pairing_hint:
        "Abrí WhatsApp en el teléfono → Ajustes → Dispositivos vinculados → Vincular un dispositivo, y escaneá esto. El código dura unos 20 segundos; pedí otro si se vence.",
      logout: "Cerrar sesión",
      logout_confirm: "Esto borra las credenciales y la sesión deja de contestar. Hay que vincular de nuevo.",
      owner_alts: "También te reconoce por {count} dirección más desde la que escribís.",
      self_is_owner: "Esta línea es mi propio teléfono",
      self_is_owner_hint: "Apagado por defecto. Dejalo apagado si es una línea dedicada donde atiende el asistente y vos le escribís desde otro teléfono.",
      owner_none: "Todavía nadie. Escribile a esta línea desde tu teléfono y después tocá \"Soy yo\" en el contacto que aparezca.",
      owner_clear: "Quitar",
      make_owner: "Soy yo",
      made_owner: "Dueño asignado",
      owner: "Dueño",
      owner_hint: "El humano para el que atiende esta línea.",
      auto_reply: "Contestar automáticamente a los contactos",
      auto_reply_hint: "Apagado, solo te contesta a vos. Nadie más recibe respuesta, y los mensajes igual quedan registrados.",
      reply_to_groups: "Contestar en grupos",
      reply_to_groups_hint: "Apagado por defecto: en un grupo, todo lo que se escribe lo leen personas que nunca aprobaste.",
      no_contacts: "Todavía nadie. El que escriba aparece acá como invitado — y a un invitado nunca se le contesta hasta que le cambies el rol.",
      role: "Rol",
      nickname: "Apodo",
      relationship: "Relación",
      bio: "Quién es",
      rules: "Reglas",
      bio_hint: "En tus palabras. Llega al turno que le contesta a esta persona — y al de nadie más.",
      rules_hint: "Qué querés que haga con ella. Va último en el prompt, así que le gana a la cautela propia del agente sobre cuánto decir.",
      name: "Nombre",
      note: "Nota",
      note_hint: "Contexto sobre esta persona. Llega al turno que le contesta.",
      contact_auto_reply: "Contestar",
      remove: "Quitar",
      no_stickers: "Todavía no aprendió ningún sticker. La primera vez que llega uno lo describe, y después se lo acuerda.",
      sticker_meaning: "Significado",
      ...
      sticker_unblock_hint: "Vuelve a poder mandarlo",
      sticker_delete: "Borrar",
      sticker_delete_hint: "Olvida el texto y la imagen \u2014 no se puede deshacer",
      sticker_delete_confirm: "\u00bfBorrar \u201c{meaning}\u201d? Se van el texto y la imagen, y la pr\u00f3xima vez que alguien lo mande se aprende de cero.",
      seen: "Visto {count}×",
      saved: "Guardado",
    },
    ...
    super_agent: {
      ...
      system_hint: "Se suma al prompt base, nunca lo reemplaza: el super-agente lo lee como indicaciones extra tuyas.",
      system_ph: "Ej.: respondé siempre en voseo y avisame antes de tocar Cheto.",
      ...
      self_model_fallback: "Si falla, seguir con la cadena del router",
  ...
  project: {
    ...
    profile: {
      ...
      desc: "Un paquete que define cómo OPERA este proyecto: su bloque de prompt y las rutinas que lo hacen correr solo. El tipo de proyecto dice qué es; el perfil es lo que lo hace funcionar así.",
      active: "Activo",
      suggested: "Sugerido",
      activate: "Activar",
      deactivate: "Desactivar",
      routines_count: "{count} rutinas",
      agents_needed: "Sus rutinas le hablan a: {slugs}",
      missing_agents: "Faltan estos agentes: {slugs}. Las rutinas se instalan igual, pero las que los nombran no tienen a quién correrle. Importalos desde Agentes → Importar.",
      activated: "{id} activo. Rutinas instaladas: {count}.",
      deactivated: "{id} desactivado. Sus {count} rutinas quedan instaladas pero apagadas.",
      replace_confirm: "Ya corre \"{active}\". Activar \"{next}\" lo reemplaza y apaga sus rutinas. ¿Seguir?",
      notice_title: "Este proyecto es {kind} pero no corre ningún perfil",
      notice_body: "El tipo sólo agrega Estructura al menú y ofrece el equipo ejecutivo. Lo que hace que opere como tal son las {count} rutinas que trae {name}: los rituales y las corridas del council. Hasta activarlo, no corre ninguna.",
      notice_config: "Ver en Config",
    },
    overview: {
    ...
    chat: {
      ...
      // Standing on a channel this panel cannot start a conversation on. Names
      // the channel rather than greying out in silence.
      new_session_channel: "Una sesión nueva sale por la web — este chat es de {channel}",
      rename:       "Renombrar",
      ...
      rewind_regen_title:   "Regenerar la respuesta",
      rewind_regen_confirm: "Regenerar",
      rewind_edit_title:    "Editar y reenviar",
      rewind_edit_confirm:  "Editar y reenviar",
      rewind_desc_newer:    "Esto borra esta respuesta y {n} mensaje(s) posteriores. No se puede deshacer.",
      rewind_desc_last:     "Se borra esta respuesta y se vuelve a pedir. No se puede deshacer.",
    ...
    agents: {
      ...
      slug_invalid: "Usá minúsculas, dígitos, - o _, empezando por una letra.",
      slug_required: "Ponele un nombre o escribí un slug.",
      hierarchy:   "Jerarquía",
      list_view:   "Lista",
      import:      "Importar",
      chat:        "Chat",
      ...
      pack_warn_root_chip: "2.ª raíz",
      pack_warn_orphan_chip: "Sin padre",
      pack_warn_second_root: "Este proyecto ya tiene orquestador ({names}). {slug} entra sin padre, así que quedan dos raíces y la jerarquía se parte en dos árboles sueltos. A nadie se lo degrada: después colgás uno del otro con el campo Padre.",
      pack_warn_orphans: "Sin {lead} tildado no hay de quién colgarlos: {slugs} quedan sin padre, sueltos en la raíz. Tildá {lead}, o asignales Padre después de instalar.",
      pack_success: "{count} agentes instalados",
      import_btn:  "Importar",
      preview_btn:   "Ver",
      preview_label: "Ver la plantilla {slug}",
      preview_model: "Modelo",
      preview_model_default: "default del router",
      preview_type:  "Tipo",
      preview_autonomy: "Autonomía",
      preview_parent: "Reporta a",
      preview_tools: "Tools",
      preview_skills: "Skills",
      preview_tools_default: "las del proyecto",
      preview_skills_none: "ninguna",
      preview_prompt: "System prompt",
      preview_no_prompt: "La plantilla no trae prompt.",
    },
    ...
    agent_detail: {
      ...
      tab_config:      "Config",
      tab_prompt:      "Prompt",
      tab_tools:       "Skills & tools",
      tools_card_title: "Skills y tools",
      tools_card_count: "{n} tools · {s} skills",
    ...
    config: {
      ...
      section_desc: "Lo propio de este proyecto. Lo que no toques acá lo resuelve la config general en Settings.",
      effective_read: "Lectura: global APX + proyecto.",
      save_project: "Metadata del proyecto guardada.",
      save_override: "Config del proyecto guardada.",
      save_fields_success: "Guardado.",
      save_meta_success: "Metadata del proyecto guardada.",
      no_data:     "Sin datos.",
      tab_settings: "Settings",
      tab_project: "Proyecto",
      json_config_desc: "Config de este proyecto: sólo en esta máquina, nunca en el repo. Acá pueden ir claves.",
      json_meta_desc: ".apc/project.json — viaja con el repo. Sin claves: el daemon rechaza lo que parezca una.",
    },
  ...
  code_module: {
    ...
    stopped:      "[detenido]",
    rewind_confirm_regenerate: "¿Volver a pedir esta respuesta?",
    rewind_confirm_edit:       "¿Cambiar lo que pediste y volver a preguntar?",
    rewind_confirm_desc:       "Se borran {n} turno(s) de esta sesión, con las tools que corrieron. No se puede deshacer. Los archivos que ya se tocaron en el disco quedan como están.",
    rewind_confirm_go:         "Borrar y volver a pedir",
    close:               "Cerrar",
    reload:              "Recargar",
  ...
  skill_probe: {
    title:                "¿Qué skills traería este mensaje?",
    desc:                 "Escribí un mensaje como lo mandarías y mirá qué haría el RAG por turno: qué skills inyectaría, cuáles sólo nombraría y cuáles descartaría. No se le manda nada al modelo.",
    placeholder:          "¿Me hacés una imagen de un zorro?",
    run:                  "Probar",
    failed:               "Falló la prueba: {msg}",
    no_embedder:          "Sin embedder",
    inspector_off:        "Inspector apagado — esto es una prueba",
    jit:                  "Sin índice — calculado al vuelo",
    index_mismatch:       "El índice se armó con '{index}' — reindexá",
    scored_n:             "{n} skills puntuadas",
    degraded:             "Está corriendo el fallback offline (tf), que compara palabras literales: un mensaje en un idioma no le va a pegar a una skill escrita en otro, y todo puntúa bajo. Para que estos números signifiquen algo hace falta un modelo de embeddings de verdad.",
    fix_embedder:         "Configurar el embedder",
    outcome_injected:     "Inyectadas: {loaded} · sugeridas: {hinted}",
    outcome_nothing:      "Con este mensaje no le llegaría ninguna skill al agente.",
    load_blocked_below_load_z: "La primera no llegó a la relevancia que hace falta para inyectar el cuerpo ({load_z}).",
    load_blocked_margin:  "La primera no le sacó suficiente ventaja a la segunda ({margin_z}), así que no se inyectó ningún cuerpo.",
    col_skill:            "Skill",
    col_sim:              "Similitud (piso {floor})",
    col_rel:              "Relevancia (barra {hint})",
    col_verdict:          "Veredicto",
    verdict_loaded:       "Inyectada",
    verdict_hinted:       "Sugerida",
    verdict_unrelated:    "Debajo del piso de similitud",
    verdict_weak:         "Debajo de la barra",
    verdict_capped:       "Sin lugar",
    show_all:             "Ver las otras {n}",
    tools_note:           "Las tools no se eligen así: el agente arranca siempre con su set base y activa el resto con discover_tools. Todo lo demás — generar una imagen, por ejemplo — vive en una skill, que es lo que decide esta tabla.",
  },
  memory_panel: {
  ...
  providers_modal: {
    ...
    delete:              "Borrar",
    locked:              "Fijo — plan Codex/Claude, no se puede borrar",
    codex_plan_desc:     "Puente al plan ChatGPT / Codex. Login APX propio (`apx auth chatgpt-codex login`) — sin API key.",
    codex_plan_hint:     "Proveedor fijo de plan. Cobra contra tu suscripción ChatGPT/Codex.",
    codex_model_hint:    "Solo modelos que acepta tu plan Codex. Sale del cache local de Codex cuando hay.",
    codex_login_help:    "Login APX: `apx auth chatgpt-codex login` → ~/.apx/auth/chatgpt-codex.json (familia aparte del CLI). Fallback temporal: codex login.",
    claude_plan_desc:    "Puente a Claude Max (+ créditos extra). Login APX: `apx auth claude login` — sin API key.",
    claude_plan_hint:    "Proveedor fijo. Cobra créditos extra del plan Max (Pro solo no alcanza).",
    claude_login_help:   "Login APX: `apx auth claude login` → ~/.apx/auth/claude-subscription.json. Claude Code CLI queda intacto.",
    custom:              "Custom",
    json_mode:           "JSON",
  ...
  providers_card: {
    ...
    api_key:             "API key",
    key_set:             "✓ seteada",
    plan_auth:           "Plan OAuth (APX)",
    plan_logged_in:      "Sesión APX activa",
    plan_logged_out:     "Sin login APX",
    plan_login:          "Iniciar sesión",
    plan_login_manage:   "Gestionar sesión",
    temp:                "Temp",
    price_io:            "$ in/out (1M)",
  },
  ...
  plan_login: {
    title:          "Sesión {name}",
    codex_desc:     "Device code → tokens en ~/.apx. Codex CLI no se toca.",
    claude_desc:    "PKCE Claude Max (+ créditos extra) → ~/.apx. Claude Code CLI no se toca.",
    status_in:      "Logueado · {hint}…",
    status_out:     "Sin sesión APX",
    login:          "Login",
    relogin:        "Volver a loguear",
    logout:         "Cerrar sesión",
    codex_preflight_title: "Antes de continuar",
    codex_preflight_body:
      "ChatGPT pide activar «Device code authorization for Codex» en Seguridad. Sin eso no podrás completar el login.",
    codex_preflight_link: "Abrir ajustes de seguridad de ChatGPT",
    codex_preflight_check: "Ya activé Device code authorization for Codex",
    codex_steps:    "Abrí el link, ingresá el código y esperá — APX detecta solo.",
    enter_code:     "Código:",
    copied:         "Copiado",
    waiting:        "Esperando que termines el login…",
    claude_steps:   "Autorizá en el browser y pegá el código acá (a veces viene como code#state).",
    open_auth:      "Abrir autorización Claude",
    code_label:     "Código de autorización",
    code_hint:      "Pegá el código que muestra Claude después de aprobar.",
    submit_code:    "Confirmar",
    success:        "Login OK. Tokens guardados bajo ~/.apx/auth/.",
    err:            "Falló el login",
  },
  ...
  jobs: {
    ...
    running_command:      "{agent} está corriendo un comando",
  ...
  chat_ui: {
    ...
    send:                "Enviar",
    queued:              "En cola",
    pending_interrupting: "Interrumpiendo",
    queued_cancel:       "No mandarlo",
    queued_send_now:     "Mandar este ahora",
    queued_move_up:      "Mandarlo antes",
    queued_move_down:    "Mandarlo después",
    running_elsewhere:   "Escribiendo respuesta",
    unread_reply:        "Respuesta nueva",
    send_mode_interrupt: "Interrumpe",
    send_mode_queue:     "Encola",
    send_mode_tip_interrupt: "Escribir durante un turno lo corta y arranca con tu mensaje. Ctrl+Enter encola igual. Tocá para cambiar el default.",
    send_mode_tip_queue:     "Escribir durante un turno espera a que termine. Ctrl+Enter hace lo mismo siempre. Tocá para cambiar el default.",
  ...
  agent_detail_extra: {
    ...
    tools_declared: "Tools · {count} (declaradas para este agente)",
    tools_default: "Tools · {count} (default del proyecto — sin lista declarada)",
    tools_more: "+{count} más",
    tools_less: "Ver menos",
  },
  ...
  voice_ui: {
    ...
    replies_label:       "Mandar parte en audio",
    replies_desc:        "La respuesta abre con una nota de voz y el texto completo sigue como siempre. Pedíselo en voz alta para cambiarlo en una conversación.",
    stream_label:        "Streaming de audio",
    stream_desc:         "Empieza a hablar mientras todavía se está generando el audio. Sólo en el desktop.",
    stream_unsupported:  "Ningún motor configurado responde en la ruta de streaming.",
    ...
    language_hint:        "El idioma que se le pide al servidor. Sólo se manda a endpoints custom. Vacío = lo que el servidor tenga de default, que es una adivinanza y no una decisión.",
    language_server_default: "Default del servidor",
    qvox_voice_hint:      "Un speaker preset de tu servidor. Cada uno trae SU propio acento, así que el preset le gana al acento que describas en el Estilo. Vacío = el Estilo diseña la voz.",
    voice_none:           "Ninguna — diseñar la voz desde el Estilo",
    qvox_style_hint:      "Se manda al servidor como `instruct`. Sólo algunos motores lo usan: QVox/Qwen3-TTS diseña la voz con esto — timbre, edad, acento, ritmo ('un hombre argentino cálido, acento rioplatense') — mientras que Pocket TTS no tiene instruct y lo descarta, así que ahí la Voz es toda la voz.",
    style_overridden_hint: "Con un speaker elegido, un motor que entienda instruct sólo tiñe la interpretación — la voz y el acento del speaker ganan. Vaciá el campo Voz para que el estilo diseñe la voz. Los motores sin instruct ignoran este campo igual.",
    clone_label:          "Grabación de referencia (clonado, opcional)",
    clone_hint:           "Ruta en el filesystem DEL SERVIDOR a una grabación limpia de 10–20s. El clonado es el único modo que reproduce un acento que ningún preset tiene. Le gana a Voz y a Estilo.",
    ref_text_label:       "Qué dice la grabación",
    ref_text_hint:        "Opcional, y conviene completarlo: decirle al modelo qué está escuchando acelera bastante el clonado.",
    ...
    test_voice_label:     "Voz",
    test_voice_hint:      "Sólo para esta prueba — no cambia lo que el motor tiene guardado.",
    test_voice_default:   "Default del motor",
    ...
    delivery_desc:       "Cómo te llega una respuesta cuando se habla.",
  ...
  agent_tools: {
    ...
    tab_skills:      "Skills",
    title:           "Tools",
    desc:            "Qué puede llamar este agente. Tildá un grupo entero y sacá lo que no quieras.",
    use_all:         "Todas las tools",
    use_all_on:      "Hereda las {count} del registry. Apagalo para elegir por grupo.",
    use_all_off:     "{picked} de {total} elegidas, más las fijas.",
    core_title:      "Siempre activas",
    core_hint:       "Sin esto un agente no puede buscar tools, leer sus skills ni contestarle a otro agente. No se sacan.",
    group_tasks:     "Tasks y compromisos",
    group_files:     "Archivos",
    group_messages:  "Mensajes",
    group_agents:    "Agentes",
    group_memory:    "Memoria",
    group_sessions:  "Sesiones",
    group_code:      "Código (git)",
    group_shell:     "Shell",
    group_mcp:       "MCP",
    group_skills:    "Skills",
    group_routines:  "Rutinas",
    group_artifacts: "Artifacts",
    group_projects:  "Proyectos",
    group_inventory: "Inventario",
    group_integrations: "Integraciones",
    group_browser:   "Browser",
    group_fetch:     "HTTP",
    group_search:    "Búsqueda web",
    group_runtime:   "Runtimes",
    group_voice:     "Voz",
    skills_desc:     "Skills que se inyectan en el prompt de este agente.",
    skills_none:     "No se inyecta ninguna skill en el prompt.",
    skills_reachable: "Las {count} del proyecto siguen alcanzables a demanda con load_skill.",
    skills_clear:    "Ninguna",
    skills_all:      "Todas las del proyecto",
    skills_all_hint: "Se inyectan enteras: una lista larga es un prompt largo.",
  },
  agents_form: {
    emoji:           "Emoji",
    icon:            "Avatar",
    ...
    skills_use_defaults: "Sin skills declaradas",
    skills_use_defaults_hint: "Estas skills se inyectan enteras en el prompt del agente.",
    ...
    master_conflict: "Ya hay orquestador acá: {names}. Pueden ser varios — el flag sólo habilita renombrar y borrar agentes, y a los que ya están no les pasa nada.",
    master_conflict_root: "Sin padre, este queda como segunda raíz y la jerarquía se parte en dos árboles sueltos.",
    area:            "Área",
    role:            "Rol",
    no_role:         "— sin rol —",
    autonomy:        "Autonomía",
  ...
  tasks: {
    ...
    location_at_invalid: "Formato: latitud, longitud (ej. -41.1335, -71.3103)",
    location_place_ph: "Farmacia del Puente",
    location_address_ph: "Av. San Martín 1234, Bariloche",
    location_radius: "Radio (m)",
    location_radius_ph: "Por defecto",
    location_hint: "Dónde hay que pasar. El nombre solo ya sirve para el aviso; las coordenadas son las que disparan el geocerco cuando vas manejando.",
    field_category: "Tipo",
    state_open:      "Abiertas",
    state_done:      "Hechas",
    ...
    field_status:    "Estado",
    field_agent:     "Agente",
    // "A cargo", no "Agente": el valor puede ser una persona (vos), y un campo
    // llamado "Agente" que dice "Humano" se lee como un error.
    field_assignee:  "A cargo",
    field_priority:  "Prioridad",
    field_reminder:  "Recordatorio",
    assignee_owner:  "👤 Humano (vos)",
    priority_low:    "⚪ Baja",
    priority_normal: "🟢 Normal",
    priority_high:   "🟠 Alta",
    priority_urgent: "🔴 Urgente",
    reminder_none:   "Sin recordatorio",
    reminder_once:   "Una vez",
    reminder_daily:  "Diario",
    reminder_weekly: "Semanal",
    mention_title:   "Mencionar a alguien",
    mention_insert:  "Mencionar",
    mention_empty:   "No hay nadie a quien mencionar en este proyecto.",
  ...
  settings_ui: {
    ...
    knob_load_z:                "Relevancia para inyectar",
    knob_load_z_hint:           "Cuánto tiene que puntuar una skill por encima de su propia base para que se inyecte su CUERPO (más alto = más estricto).",
    knob_hint_z:                "Relevancia para sugerir",
    knob_hint_z_hint:           "Misma escala, barra más baja: la skill sólo se NOMBRA, y el agente la carga si quiere.",
    knob_margin_z:              "Margen sobre la 2da",
    knob_margin_z_hint:         "La primera tiene que superar a la segunda por este margen para cargar su cuerpo (evita empates flojos).",
    knob_raw_floor:             "Piso de similitud",
    knob_raw_floor_hint:        "Similitud cruda por debajo de la cual una skill se descarta por no tener que ver, antes de cualquier ranking. Bajalo si te está cortando coincidencias en otro idioma.",
    ...
    cfg_behaviour_label:        "Comportamiento",
    cfg_behaviour_desc:         "Cómo trabajan los agentes en este proyecto. Vacío = lo que diga la config general.",
    cfg_permission_mode:        "Permisos",
    ...
    cfg_project_label:          "Identidad",
    cfg_project_desc:           "Lo que el proyecto ES. Viaja con el repo en .apc/project.json — sin claves.",
    cfg_name:                   "Nombre",
    cfg_version:                "Versión",
  ...
  project_models: {
    chain_title:    "Cadena de modelos",
    chain_desc:     "Con qué contesta este proyecto. El #1 es el default; los de abajo entran cuando el de arriba falla.",
    inherited:      "Hoy usa la cadena general:",
    fallback:       "Si falla",
    add_step:       "Agregar",
    use_global:     "Volver a la general",
    move_up:        "Subir",
    move_down:      "Bajar",
    engines_title:  "Motores de este proyecto",
    engines_desc:   "Proveedores que existen sólo acá, además de los generales. Se guardan fuera del repo, así que la clave no se publica.",
    engines_empty:  "Ninguno. Este proyecto usa los motores generales.",
    add_engine:     "Agregar motor",
    also_available: "También disponibles:",
    slug:           "Nombre corto",
    slug_hint:      "Con esto lo nombrás en la cadena: mi-proveedor:modelo.",
    slug_required:  "Falta el nombre corto.",
    engine_kind:    "Tipo",
    default_model:  "Modelo por defecto",
    key_keep:       "Vacío deja la clave que ya está guardada.",
    key_local:      "Queda en esta máquina, nunca en el repo.",
  },
  ...
  shared_ui: {
    ...
    tool_list_tasks:       "Ver tasks",
    tool_get_task:         "Leer task",
    tool_update_task:      "Editar task",
    tool_complete_task:    "Cambiar estado",
    tool_comment_task:     "Comentar task",
    dedup:                 "Dedup",
    tool_running:          "Corriendo",
    tool_error:            "Falló",
    tool_done:             "Listo",
    tokens_detail:         "Entrada {in} · Salida {out}",
    args:                  "Args",
    result:                "Result",
    auto:                  "Auto",
