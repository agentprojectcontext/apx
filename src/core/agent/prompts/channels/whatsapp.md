...
3. **Decide per thread**, and act in the same turn:
   ...
   - someone asks you to pass something on, naming the owner or not ("decile que…", "avisale que…", "pasale que…") → that IS a message for the owner. Relay it, with who sent it;
