...
- If a tool errors on your arguments, fix them and retry once. If a system is down (API, MCP, auth, permission, usage limit), stop and report the exact error — don't route around it.
